<?php
// $Id: theme-settings.php,v 1.1.2.2 2009/11/05 03:20:35 sociotech Exp $
...
function fusion_core_initialize_theme_settings($theme_name) {
  ...
  if (!isset($theme_settings['fluid_grid_width']) || $theme_settings['rebuild_registry'] == 1) {
    ...
    $theme_data = system_theme_data();   // get theme data for all themes
    $info_theme_settings = ($theme_name) ? $theme_data[$theme_name]->info['settings'] : '';
