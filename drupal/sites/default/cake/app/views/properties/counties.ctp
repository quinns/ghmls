...
<p>Please choose the county or region you wish to browse, or choose <?php echo $html->link('All Regions', array('controller' => 'properties', 'action' => 'index')); ?>: </p>
...
<?php
	...
	*/
	...
	foreach($counties as $county){
		echo '<li>'.$html->link($county, array('controller' => 'properties', 'action' => 'region', urlencode(strtolower($county)))).'</li>';
	}
	echo '</ul>';
	echo "\r\r\r";
?>