<p>MEMBER OFFICES: Are you sure you wish to perform the database import at this time?</p>
<?php
	echo $form->create(array('controller' => 'imports', 'action' => 'ftp_download_agent_offices'));
