...
<?php echo $form->create('BusinessOpp');?>
	<fieldset>
 		<legend><?php __('Edit BusinessOpp');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('BusinessOpp.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('BusinessOpp.id'))); ?></li>
