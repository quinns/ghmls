...
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $html->link($listingImage['ListingImage']['id'], array('admin' => 0, 'controller' => 'listing_images', 'action' => 'view', $listingImage['ListingImage']['id'])); ?>
		</td>
		<td>
			<?php echo $html->link($listingImage['ListingImage']['mls_number'], array('admin' => 0, 'controller' => 'listings', 'action' => 'view', $listingImage['ListingImage']['mls_number'])); ?>
		</td>
		<td>
