...
'format' => __('%current% results found. Page %page% of %pages%', true)
));
?></p>
<div class="paging">
...
<table cellpadding="4" cellspacing="0" width="100%" class="ghresultstable">
	...
	<tr<?php echo $class;?>>
		<td>
			...
			if(!empty($listing['ListingImage'][0]['id']['local_path'])){
				...
				echo '<img src="/sites/greathomes.org/files/assets/mls-no-image.gif" width="125" height="90" />';
			}	
			 ?>
		</td>
		<td>
