...
<?php
	// NOTE THIS CODE HAS BEEN MOVED TO /views/properties/semi_advanced.ctp
	...
	*/
	...
	echo $form->create(array('url' => '/propertiess/search_city')); 
...
*/
	...
	echo $html->link('Advanced Search', array('controller' => 'properties', 'action' => 'search'));
